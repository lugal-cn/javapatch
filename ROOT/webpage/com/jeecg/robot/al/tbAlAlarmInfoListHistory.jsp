...
<div class="easyui-layout" fit="true">
 ...
 <div id="tempSearchColums" >
  ...
  <t:datagrid name="tbAlAlarmInfoList" checkbox="true" pagination="true" fitColumns="true" title="告警信息" actionUrl="tbAlAlarmInfoController.do?datagrid1" idField="id" sortName="alarmTime" fit="true" queryMode="group">
   ...
   <t:dgCol title="机器人名称"  field="robotsInfoName"  query="true" dictionary="tb_his_patrol,distinct robots_info_name,robots_info_name" queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="告警类型"  field="alarmType"  dictionary="itacs_alarmType" queryMode="group"  width="120"></t:dgCol>
   <t:dgCol title="处理状态"  field="handStatus" dictionary="itacs_handStatus" query="true" queryMode="single"  width="80"></t:dgCol>
