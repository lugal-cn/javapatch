...
<script type="text/javascript" src="plug-in/select2/js/select2.full.min.js"></script>
 ...
 <form id="formobj" action="tbCrEquipmentController.do?doUpdate&id=${tbCrEquipmentPage.id}"  class="form-horizontal validform" role="form"  method="post">
	<input type="hidden" id="btn_sub" class="btn_sub"/>
	<input type="hidden" id="id" name="id" value="${tbCrEquipmentPage.id}"/>
	<div class="form-group">
		<label for="equipmentNo" class="col-sm-3 control-label">设备编码：</label>
		<div class="col-sm-6">
			<div class="input-group" style="width:100%">
				<input id="equipmentNo" name="equipmentNo" value='${tbCrEquipmentPage.equipmentNo}' readonly="readonly" type="text" maxlength="100" validType="tb_cr_equipment,equipment_no,id" class="form-control input-sm" placeholder="请输入设备编码"  datatype="*"  ignore="checked" />
			</div>
		</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-6">
			<div class="input-group" style="width:100%">
				<input id="equipmentName" name="equipmentName" value='${tbCrEquipmentPage.equipmentName}' readonly="readonly" type="text" maxlength="200" class="form-control input-sm" placeholder="请输入设备名称"  datatype="*"  ignore="checked" />
			</div>
		</div>
		<font style="color: red;">*</font>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<textarea id="equipmentDesc" name="equipmentDesc" class="form-control" readonly="readonly" placeholder="请输入设备描述" rows="4">${tbCrEquipmentPage.equipmentDesc}</textarea>
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-6">
			<div class="input-group" style="width:100%">
				<t:dictSelect field="equipmentStatus" type="select" readonly="readonly" defaultVal="${tbCrEquipmentPage.equipmentStatus}" hasLabel="false"  title="设备状态" extendJson="{class:'form-control input-sm'}"  datatype="*"  typeGroupCode="itacs_equipment_status" ></t:dictSelect>
			</div>
		</div>
		<font style="color: red;">*</font>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-6">
			<div class="input-group" style="width:100%">
				<input type="text" id="equipmentType" name="equipmentType"   disabled="disabled" readonly="readonly" value='${tbCrEquipmentPage.equipmentType}'  datatype="*" class="ac_input"  onchange="equipmentTypeChange()">
			</div>
		</div>
		<font style="color: red;">*</font>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-6">
			<div class="input-group" style="width:100%">
				<input id="equipmentModel" name="equipmentModel" type="text" disabled="disabled" readonly="readonly" value='${tbCrEquipmentPage.equipmentModel}'  datatype="*" class="ac_input" onchange="equipmentModelChange()"/>
			</div>
		</div>
		<font style="color: red;">*</font>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-6">
			<div class="input-group" style="width:100%">
				<input id="equipmentIp" name="equipmentIp" readonly="readonly"  datatype="ip" type="text" value='${tbCrEquipmentPage.equipmentIp}' maxlength="100" class="form-control input-sm" placeholder="请输入设备IP"   onblur="isValidIP()"/>
			</div>
		</div>
		<font style="color: red;">*</font>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-6">
			<div class="input-group" style="width:100%">
				<t:dictSelect field="equipmentGrade" type="select"  readonly="readonly" defaultVal="${tbCrEquipmentPage.equipmentGrade}" datatype="*" hasLabel="false" title="设备等级" extendJson="{class:'form-control input-sm'}"   typeGroupCode="itacs_equipment_grade" ></t:dictSelect>
			</div>
		</div>
		<font style="color: red;">*</font>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-6">
			<div class="input-group" style="width:100%">
				<input type="text" id="computerRoomId" name="computerRoomId"  disabled="disabled" readonly="readonly" value='${tbCrEquipmentPage.computerRoomId}' datatype="*" class="ac_input" onchange="computerRoomIdChange()">
			</div>
		</div>
		<font style="color: red;">*</font>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-6">
			<div class="input-group" style="width:100%">
				<input type="text" id="cabineNo"  datatype="*" readonly="readonly" disabled="disabled" value='${tbCrEquipmentPage.cabineNo}' name="cabineNo" class="ac_input">
			</div>
		</div>
		<font style="color: red;">*</font>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-6">
			<div class="input-group" style="width:100%">
				<input id="uBitStart" name="uBitStart" type="text" readonly="readonly" maxlength="2" value='${uBitStart}'  datatype="*" validType="tb_cr_equipment,u_bit_start,id" validUbit="uBitEnd" class="form-control input-sm" placeholder="请输入U位信息起始位" />
			</div>
		</div>
		<font style="color: red;">*</font>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-6">
			<div class="input-group" style="width:100%">
				<input id="uBitEnd" name="uBitEnd" type="text" readonly="readonly"  maxlength="2"  value='${uBitEnd}' datatype="*"  validType="tb_cr_equipment,u_bit_end,id"       validUbit="uBitStart" class="form-control input-sm" placeholder="请输入U位信息结束位"/>
			</div>
		</div>
		<font style="color: red;">*</font>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-6">
			<div class="input-group" style="width:100%">
				 <input type="text" id="deptId"  datatype="*"  disabled="disabled" readonly="readonly" value='${tbCrEquipmentPage.deptId}' name="deptId" class="ac_input">
			</div>
		</div>
		<font style="color: red;">*</font>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">  
				<img  id="img" onerror="this.style.display='none'" src="${tbCrEquipmentPage.positiveReferenceUrl}" width="200" height="200">	
	...
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
       <img id="img1" onerror="this.style.display='none'" src=" ${tbCrEquipmentPage.backDatumUrl}" width="200" height="200">		
		        	...
		        	if(mapBack) {
		        		for(var j = 0; j < mapBack.length; j++) {
		        			if(backRecognitionPoints.indexOf(mapBack[j].pointsNo) != -1) {
		        				 ...
		        				 htmBack +='<input type="checkbox" name="backRecognitionPoints" value="'+mapBack[j].pointsNo+'" id="frontalRecognitionPoints"  class="i-checks" />'+mapBack[j].pointsName+'&nbsp;&nbsp;';
		        			}
			        	}
		        	}
					if(mapFrontal) {
						for(var j = 0; j < mapFrontal.length; j++) {
							if(frontalRecognitionPoints.indexOf(mapFrontal[j].pointsNo) != -1) {
		        				...
		        				htmFrontal +='<input type="checkbox" name="frontalRecognitionPoints" value="'+mapFrontal[j].pointsNo+'" id="frontalRecognitionPoints"  class="i-checks" />'+mapFrontal[j].pointsName+'&nbsp;&nbsp;';
		        			}
