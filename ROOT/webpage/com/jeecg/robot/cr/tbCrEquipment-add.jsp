...
<script type="text/javascript" src="plug-in/select2/js/select2.full.min.js"></script>
 ...
 <form id="formobj" action="tbCrEquipmentController.do?doAdd" class="form-horizontal" role="form" callback="saveObjcallback" method="post">
	...
	<div class="form-group">
		...
		<div class="col-sm-6">
			<div class="input-group" style="width:100%">
				<input id="equipmentNo" name="equipmentNo" type="text" maxlength="100" validType="tb_cr_equipment,equipment_no,id" class="form-control input-sm" placeholder="请输入设备编码"  datatype="*"  ignore="checked" />
			</div>
		</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-6">
			<div class="input-group" style="width:100%">
				<input id="equipmentName" name="equipmentName" type="text" maxlength="200" class="form-control input-sm" placeholder="请输入设备名称"  datatype="*"  ignore="checked" />
			</div>
		</div>
		<font style="color: red;">*</font>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<textarea id="equipmentDesc" name="equipmentDesc" class="form-control" placeholder="请输入设备描述" rows="4"></textarea>
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-6">
			<div class="input-group" style="width:100%">
				<t:dictSelect field="equipmentStatus" type="select" hasLabel="false"  title="设备状态" extendJson="{class:'form-control input-sm'}"  datatype="*"  typeGroupCode="itacs_equipment_status" ></t:dictSelect>
			</div>
		</div>
		<font style="color: red;">*</font>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-6">
			<div class="input-group" style="width:100%">
				<input type="text" id="equipmentType" name="equipmentType"  datatype="*" class="ac_input"  onchange="equipmentTypeChange()">
			</div>
		</div>
		<font style="color: red;">*</font>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-6">
			<div class="input-group" style="width:100%">
				<input id="equipmentModel" name="equipmentModel" type="text"  datatype="*" class="ac_input" onchange="equipmentModelChange()"/>
			</div>
		</div>
		<font style="color: red;">*</font>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-6">
			<div id="zmsbd" class="input-group" style="width:100%">
				<%-- <t:dictSelect id="frontalRecognitionPoints"  field="frontalRecognitionPoints" datatype="*" type="checkbox" extendJson="{class:'i-checks'}" readonly="false" typeGroupCode="itacs_frontal_recognition_points"  hasLabel="false"  title="正面识别点"></t:dictSelect> --%>
			</div>
		</div>
		<font style="color: red;">*</font>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-6">
			...
			<%-- 	<t:dictSelect id="backRecognitionPoints"  field="backRecognitionPoints"  datatype="*" type="checkbox" extendJson="{class:'i-checks'}" readonly="false" typeGroupCode="itacs_back_recognition_points"  hasLabel="false"  title="背面识别点"></t:dictSelect> --%>
			</div>
		</div>
		<font style="color: red;">*</font>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-6">
			<div class="input-group" style="width:100%">
				<t:dictSelect field="equipmentGrade" type="select"  datatype="*" hasLabel="false" title="设备等级" extendJson="{class:'form-control input-sm'}"   typeGroupCode="itacs_equipment_grade" ></t:dictSelect>
			</div>
		</div>
		<font style="color: red;">*</font>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-6">
			<div class="input-group" style="width:100%">
				<input type="text" id="computerRoomId" name="computerRoomId"  datatype="*" class="ac_input" onchange="computerRoomIdChange()">
			</div>
		</div>
		<font style="color: red;">*</font>
	</div>
	<div class="form-group" style="display:none" id="yincang1">
		<label for="equipmentIp" class="col-sm-3 control-label">设备IP：</label>
		<div class="col-sm-6">
			<div class="input-group" style="width:100%">
				<input id="equipmentIp" name="equipmentIp"  datatype="ip" validEquipmentIp="equipmentIp" type="text" maxlength="100" validEquimentIp="equipmentIp" class="form-control input-sm" placeholder="请输入设备IP"  />
			</div>
		</div>
		<font style="color: red;">*</font>
	</div>
	<div class="form-group" style="display:none" id="yincang2">
		<label for="cabineNo" class="col-sm-3 control-label">所属机柜：</label>
		<div class="col-sm-6">
			<div class="input-group" style="width:100%">
				<input type="text" id="cabineNo"  datatype="*" name="cabineNo" class="ac_input" onchange="cabineNofunction()">
			</div>
		</div>
		<font style="color: red;">*</font>
	</div>
	
	<div class="form-group" style="display:none" id="yincang3">
	...
	<div class="form-group" style="display:none" id="yincang4">
		<label for="uBitEnd" class="col-sm-3 control-label">U位信息结束位：</label>
		<div class="col-sm-6">
			<div class="input-group" style="width:100%">
				<input id="uBitEnd" name="uBitEnd" type="text" maxlength="2" validUbit="uBitStart" datatype="*" class="form-control input-sm" placeholder="请输入U位信息结束位"/>
			</div>
		</div>
		<font style="color: red;">*</font>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-6">
			<div class="input-group" style="width:100%">
				 <input type="text" id="deptId"  datatype="*" name="deptId" class="ac_input">
			</div>
		</div>
		<font style="color: red;">*</font>
	</div>
...
<script type="text/javascript">
	...
	function computerRoomIdChange(){
		...
		if(computerRoomId!=null&&computerRoomId!=''){
			document.getElementById("yincang1").style.display="";
			document.getElementById("yincang2").style.display="";
			
		}
	}
	//点击机柜时触发的事件
	function cabineNofunction(){
		var cabineNo = $("#cabineNo").val();
		document.getElementById("yincang3").style.display="";
		document.getElementById("yincang4").style.display="";
	}
	//通过设备类型查询设备型号 ftf
