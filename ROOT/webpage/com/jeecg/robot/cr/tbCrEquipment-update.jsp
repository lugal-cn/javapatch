...
<script type="text/javascript" src="plug-in/select2/js/select2.full.min.js"></script>
 ...
 <form id="formobj" action="tbCrEquipmentController.do?doUpdate" class="form-horizontal validform" role="form"  method="post">
	...
	<div class="form-group">
		...
		<div class="col-sm-6">
			<div class="input-group" style="width:100%">
				<input id="uBitStart" name="uBitStart" type="text" maxlength="2" value='${uBitStart}'  datatype="*" validUbit="uBitEnd" class="form-control input-sm" placeholder="请输入U位信息起始位" />
			</div>
		</div>
		<font style="color: red;">*</font>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-6">
			<div class="input-group" style="width:100%">
				<input id="uBitEnd" name="uBitEnd" type="text"  maxlength="2"  value='${uBitEnd}' datatype="*" validUbit="uBitStart" class="form-control input-sm" placeholder="请输入U位信息结束位"/>
			</div>
		</div>
		<font style="color: red;">*</font>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<t:webUploader name="positiveReferenceUrl" outJs="true" auto="true" fileNumLimit="1" showImgDiv="filediv_positiveReferenceUrl" pathValues="${tbCrEquipmentPage.positiveReferenceUrl}" type="image" buttonText='更换图片' displayTxt="false"></t:webUploader>
	...
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<t:webUploader name="backDatumUrl" outJs="true" auto="true" fileNumLimit="1" showImgDiv="filediv_backDatumUrl" pathValues="${tbCrEquipmentPage.backDatumUrl}" type="image" buttonText='更换图片' displayTxt="false"></t:webUploader>
