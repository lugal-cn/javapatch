...
<script type="text/javascript" src="plug-in/ace/js/bootstrap-multiselect.js"></script>
 ...
 <div class="container" style="width:100%;">
	...
	<form class="form-horizontal" role="form" id="formobj" action="tbVrVisitorRegistrationController.do?doUpdate1" method="POST">
		...
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<input id="visitorName" name="visitorName" value="${tbVrVisitorRegistration.visitorName}" type="text" maxlength="50" class="form-control input-sm" placeholder="请输入访客姓名"  datatype="*"  ignore="checked" />
				</div>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<input id="certNo" name="certNo" type="text" value="${tbVrVisitorRegistration.certNo}" maxlength="50" class="form-control input-sm" placeholder="请输入身份证号"  datatype="cn" ignore="checked" />
				</div>
			</div>
			<font style="color: red;">*</font>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<input id="mobilephone" name="mobilephone" value="${tbVrVisitorRegistration.mobilephone}" type="text" maxlength="50" class="form-control input-sm" placeholder="请输入手机" datatype="m" errormsg="手机号非法" />
				</div>
			</div>
			<font style="color: red;">*</font>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<input id="visitorTime" name="visitorTime" value="${tbVrVisitorRegistration.visitorTime}" type="text" class="form-control input-sm" value='${tbVrVisitorRegistration.visitorTime}' readonly="readonly"/>
				</div>
			</div>
			<font style="color: red;">*</font>
		</div>
					...
					<select class="multiselect" multiple="multiple" id="computerRoomIds" name="computerRoomIds" >
					  	<c:if test="${fn:length(computerRooms)  > 0 }">
							<c:forEach items="${computerRooms}" var="cr" varStatus="stuts">
								<c:if test="${fn:contains(tbVrVisitorRegistration.computerRoomIds,cr[0])}">
					  				<option value="${cr[0]}" selected="selected">${cr[1] }</option>
					  			</c:if>
					  			<c:if test="${!fn:contains(tbVrVisitorRegistration.computerRoomIds,cr[0])}">
		...
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<input type="text" id="approver" name="approver" value="${tbVrVisitorRegistration.approver}" class="ac_input" datatype="*">
				</div>
			</div>
			<font style="color: red;">*</font>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<textarea id="visitorReasons" name="visitorReasons"  class="form-control" placeholder="请输入来访事由" rows="4">${tbVrVisitorRegistration.visitorReasons}</textarea>
				</div>
			</div>
		</div>
	</form>
