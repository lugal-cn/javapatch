...
<t:base type="bootstrap,layer,validform,bootstrap-form"></t:base>
 ...
 <div class="container" style="width:100%;">
	...
	<form class="form-horizontal" role="form" id="formobj" action="tbRoRobotsPatrolPointController.do?doAdd" method="POST">
		...
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<input id="robotsInfoId" name="robotsInfoId" type="text" maxlength="32" class="form-control input-sm" placeholder="请输入机器人ID"  datatype="*"  ignore="checked" />
				</div>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<input id="patrolPointNo" name="patrolPointNo" type="text" maxlength="200" class="form-control input-sm" placeholder="请输入点位编号"  datatype="*"  ignore="checked" />
				</div>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<input id="xCoordinate" name="xCoordinate" type="text" maxlength="100" class="form-control input-sm" placeholder="请输入X坐标"  ignore="ignore" />
				</div>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<input id="yCoordinate" name="yCoordinate" type="text" maxlength="100" class="form-control input-sm" placeholder="请输入Y坐标"  ignore="ignore" />
				</div>
			</div>
		</div>
		<div class="form-group">
