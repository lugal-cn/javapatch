...
<t:base type="bootstrap,layer,validform,bootstrap-form"></t:base>
 ...
 <div class="container" style="width:100%;">
	...
	<div class="form-group">
		<label for="patrolPointNo" class="col-sm-3 control-label">点编号：</label>
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="patrolPointNo" name="patrolPointNo" value='${tbRoRobotsPatrolPoint.patrolPointNo}' type="text" maxlength="200" class="form-control input-sm" placeholder="请输入点编号"  datatype="*"  ignore="checked" />
			</div>
		</div>
	</div>
	<div class="form-group">
