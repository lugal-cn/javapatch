...
<style>
 ...
 <div class="container" style="width:100%;">
	...
	<form class="form-horizontal" role="form" id="formobj" action="tbRoRobotsFirmwareController.do?doAddDeviceslib" method="POST">
		<input type="hidden" id="btn_sub" class="btn_sub"/>
		<input type="hidden" id="id" name="id"/>
		<input type="hidden" id="robotsInfoId" name="robotsInfoId" class="ac_input"  value="${robotsInfoId }">
		<div class="form-group">
			<label for="firmwareVersion" class="col-sm-3 control-label">设备表名称：</label>
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<input id="firmwareVersion" name="firmwareVersion" type="text" maxlength="10" class="form-control input-sm" placeholder="请输入设备表名称"  ignore="ignore" />
				</div>
			</div>
		</div>
		<div class="form-group">
			<label for="firmwareFileUrl" class="col-sm-3 control-label">设备文件：</label>
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					 <t:webUploader name="firmwareFileUrl" fileSingleSizeLimit="500" buttonStyle="btn-green btn-M mb20" fileNumLimit="1"></t:webUploader>
				</div>
			</div>
		</div>
	</form>
