...
<script type="text/javascript">
 ...
 <body>
   <div class="row"><div class="col-sm-6" id="cd1"></div></div>  
   <div class="row"><div class="col-sm-6" id="cd2"></div></div>  
   <div class="row"><div class="col-sm-6" id="cd3"></div></div>  
<div  style="" class="main_div">

        <div class="pic_div">
            <img src="${tbHisPatrolRecord.imgUrl}" class="pic">
        </div>
    </div>
...
<script type="text/javascript">
var computerRoomName="所在机房:"+ '${computerRoomName}';
var patrolNo="巡检点编号:"+'${tbHisPatrolRecord.patrolNo}';
var cabineNo= "机柜编号:"+'${tbHisPatrolRecord.cabineNo}';
document.getElementById("cd1").innerHTML =patrolNo;//巡检点编号
document.getElementById("cd2").innerHTML =cabineNo;//机柜编号
document.getElementById("cd3").innerHTML =computerRoomName;//所在机房
var subDlgIndex = '';
