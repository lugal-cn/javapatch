...
<link  rel="stylesheet"  href="../plug-in/easyui/themes/black/mystyle.css" type="text/css" charset="utf-8">
 ...
 <div class="container" style="width:100%;">
	...
	<form class="form-horizontal" role="form" id="formobj" action="tbMsParamConfigureController.do?doAdd" method="POST">
		...
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<t:dictSelect field="paramConfigureType" type="list" extendJson="{class:'form-control input-sm'}"  datatype="*"   typeGroupCode="itacs_alarm_level"  hasLabel="false"  title="参数类型"></t:dictSelect>     
				</div>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<t:dictSelect field="paramConfigureName" type="list" extendJson="{class:'form-control input-sm'}"  datatype="*"   typeGroupCode="sf_yn"  hasLabel="false"  title="是否按部门告警"></t:dictSelect>     
				</div>
			</div>
			<font style="color: red;">*</font>
		</div>
