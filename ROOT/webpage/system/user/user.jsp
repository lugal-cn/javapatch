...
<head>
<title>用户信息</title>
<t:base type="jquery,easyui,tools,webuploader"></t:base>
<script>
	/**
	 * 选择组织机构
	 */
...
<body style="overflow-y: hidden;overflow-y:auto;">
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="userController.do?saveUser" beforeSubmit="setOrgIds">
	...
	<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<label class="Validform_label"> 用户照片: </label></td>
			<td class="value" width="10%">
               <div class="input-group" style="width:100%">
				<t:webUploader name="portrait" outJs="true" auto="true" url="userController/filedeal.do" fileNumLimit="1" showImgDiv="filediv_robotsUrl" type="image" buttonText='添加图片' pathValues="${user.portrait}" displayTxt="false" datatype="*"></t:webUploader>
		...
		<tr>
			...
			<td class="value">
                ...
                <span class="Validform_checktip">部门为单选</span>
            </td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="value">
               <input class="inputxt"  datatype="n11-11" name="mobilePhone" value="${user.mobilePhone}"  errormsg="手机号码不正确" />
