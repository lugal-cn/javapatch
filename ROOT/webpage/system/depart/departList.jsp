...
<div id="main_depart_list" class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="departList" title="部门列表" fitColumns="true" actionUrl="departController.do?departgrid" treegrid="true" idField="departid" pagination="false">
            ...
            <t:dgCol title="common.org.code" field="orgCode" hidden="true" treefield="fieldMap.orgCode" width="50"></t:dgCol>
            <t:dgCol title="common.org.type" field="orgType" hidden="true" dictionary="orgtype" treefield="fieldMap.orgType" width="60"></t:dgCol>
            <t:dgCol title="common.mobile" field="mobile" hidden="true" treefield="fieldMap.mobile" width="60"></t:dgCol>
            <t:dgCol title="common.fax" field="fax" hidden="true" treefield="fieldMap.fax" width="60"></t:dgCol>
            <t:dgCol title="common.address" field="address" hidden="true" treefield="fieldMap.address" width="100"></t:dgCol>
        ...
        <div id="departListtb" style="padding: 3px; height: 25px">
            <div style="float: left;">
                ...
                <a href="#" class="easyui-linkbutton" plain="true" icon="icon-edit" onclick="update('<t:mutiLang langKey="common.edit.param" langArg="common.department"/>','departController.do?update','departList','680px','450px')">编辑</a>
