...
<div region="center" style="padding:0px;border:0px">
	<t:datagrid name="functionList" title="menu.manage" actionUrl="functionController.do?functionGrid" idField="id" fit="true" fitColumns="true" treegrid="true" pagination="false" btnCls="bootstrap btn btn-normal btn-xs">
        ...
        <t:dgCol title="common.icon" field="TSIcon_iconPath" treefield="code" hidden="true" image="true" ></t:dgCol>
        <t:dgCol title="funcType" field="functionType" treefield="functionType" replace="funcType.page_0,funcType.from_1" hidden="true" width="20"></t:dgCol>
        ...
        <t:dgCol title="menu.funiconstyle" field="functionIconStyle" hidden="true" treefield="iconStyle" width="25"></t:dgCol>
