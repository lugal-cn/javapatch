...
<t:formvalid formid="formobj" layout="div" dialog="true" action="roleController.do?saveRole">
	...
	<fieldset class="step">
	<div class="form"><label class="Validform_label"><t:mutiLang langKey="common.role.name"/>:</label> <input name="roleName" ajaxurl="roleController.do?checkRoleName&roleName=${role.roleName }" class="inputxt" value="${role.roleName }" datatype="s2-8"> <span class="Validform_checktip"><t:mutiLang langKey="rolescope.rang2to8.notnull"/></span>
	</div>
