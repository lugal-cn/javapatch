...
<t:formvalid formid="formobj" layout="div" dialog="true" action="systemController.do?saveTypeGroup">
	...
	<input name="typegroupcode" class="inputxt" validType="t_s_typegroup,typegroupcode,id" value="${typegroup.typegroupcode }" datatype="s2-50"> <span class="Validform_checktip">编码范围在2~50位字符</span></div>
	<div class="form">
