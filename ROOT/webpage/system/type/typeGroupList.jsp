...
<div id="main_typegroup_list" class="easyui-layout" fit="true">  
    <div region="center" style="padding:0px;border:0px">
        ...
        idField="id" treegrid="false" pagination="false"  sortOrder="desc" sortName="createDate" onLoadSuccess="loadSuccess" queryMode="group" btnCls="bootstrap btn btn-info btn-xs">
            ...
            <t:dgCol title="字典编码" field="typegroupcode" width="100" treefield="code" query="true"></t:dgCol>
            ...
            <t:dgToolBar title="导出" icon="fa fa-arrow-up" funname="ExportXls"></t:dgToolBar>
            <t:dgToolBar title="导入" icon="fa fa-arrow-down" funname="ImportXls"></t:dgToolBar>
        </t:datagrid>
    </div>
</div>
...
<script type="text/javascript">
    ...
    function loadSuccess() {
  	...
  	//导出
    function ExportXls() {
  		window.location.href = "systemController.do?sjzdExportXls";
    	//JeecgExcelExport("systemController.do?sjzdExportXls","common.data.dictionary");
    }
  	
  	//导入
    function ImportXls() {
    	openuploadwin('Excel导入', 'systemController.do?upload', "");
    }
</script>
