...
<body style="overflow-y:hidden;">
	<div class="layout-admin">
		...
		<header class="layout-header">
			<span class="header-logo"><img alt="image" width="190" height="68" src="plug-in/login/images/itacs-aceplus.png" /></span>
			<div class="title_itacs" >ITACS机器人智能巡检系统</div>
			<!-- <div class="titlerow" >
				<div class="titlecell">
		...
		<section class="layout-main">
			<div class="layout-main-tab">
                ...
                <nav class="tab-nav">
                    <div class="tab-nav-content" id="tab-contents-div">
                        ...
                        <a href="javascript:void(0);" id="myhomeAtag" class="content-tab active" data-id="workbenchController.do?workbench" style="cursor:pointer">
                        <span class="fa fa-home colorgray"></span>工作台</a>
                    </div>
                </nav>
			...
			<div class="layout-main-body" style="margin:0;overflow-y: hidden;">
				<iframe class="body-iframe" name="tab_home" width="100%" height="100%" 
						src="workbenchController.do?workbench" frameborder="0" data-id="workbenchController.do?workbench" seamless></iframe>
			</div>
		</section>
